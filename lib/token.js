...
exports.KIND_VARIABLE_PARAM = "void";
...
exports.to_variable = ({kind, data}) => (
  kind in to_variable_object ?
  {
    ...
    duplicable: (
      ...
      kind === exports.KIND_VARIABLE_FUNCTION ||
...
exports.test = (kinds, data) => (
  ...
  ((token) => (
    (data === "foo" && console.log(kinds, data, token)),
    (token.kind in kinds) && (token.data === data))));
...
exports.transform = (kinds, kind, data) => (token) => (
  (
    token.kind in kinds &&
    (
      data === void 0 ||
