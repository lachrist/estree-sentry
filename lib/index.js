...
const KEY_CAPTURE = "__sentry_capture__";
const KEY_RELEASE = "__sentry_release__";
const KEY_USE_STRICT = "__sentry_use_strict__";
const KEY_EVAL_CALL = "__sentry_eval_call__";
...
const visitors = {
  ...
  Program: (node, context, _tokens, _strict) => (
    ...
    _tokens = set_hoisting(
      ...
      node),
    _tokens = ArrayLite.concat(
      ArrayLite.map(context["scope"], Token.from_variable),
      _tokens),
    ...
    _tokens = (
      (
        ...
        context["closure-context"] === "function") ?
